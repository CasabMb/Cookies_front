...
import ClientService from '../Services/ClientService'; // Assurez-vous que le chemin est correct
...
function UpdateProfil() {
    ...
    // Utiliser useEffect pour récupérer les informations du client une fois que le composant est monté
    useEffect(() => {
        ...
        fetchClientData();
    }, []); // Le tableau vide [] signifie que ce useEffect ne s'exécutera qu'une seule fois après le premier rendu du composant
